...
class NewsTask(TaskBase): 
    """
    This class instantiates the News Task Class
    ...
    def __init__(self, description, expected_output, tools, agent):
        # Initialize the News Task with the given attributes
    ...
    def build_task(self, **kwargs):
        # Build the News Task Object with the given attributes and other parameters
        task_attributes = {
        ...
        try:
            ...
            return "Failed to build News Task!"