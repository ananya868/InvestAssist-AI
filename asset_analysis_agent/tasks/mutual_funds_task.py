...
class MutualFundsTask(TaskBase): 
    """
    This class instantiates the Mutual Funds Task Class
    ...
    Methods:
        ...
        returns: 
            Mutual Funds Task Object 
    """
    def __init__(self, description, expected_output, tools, agent):
        # Initialize the Mutual Funds Task with the given attributes
    ...
    def build_task(self, **kwargs):
        # Build the Mutual Funds Task Object with the given attributes and other parameters
        task_attributes = {
        ...
        try:
            ...
            return "Failed to build Mutual Funds Task!"