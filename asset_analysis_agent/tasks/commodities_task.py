...
class CommoditiesTask(TaskBase): 
    """
    ...
    def __init__(self, description, expected_output, tools, agent):
        # Initialize the Commodities Task with the given attributes
    ...
    def build_task(self, **kwargs):
        # Build the Commodities Task Object with the given attributes and other parameters
        task_attributes = {
        ...
        try:
            ...
            return "Failed to build Commodities Task!"