...
class CryptoAgent(AgentBase):
    """ 
    This class instantiates the Crypto Agent Class
    ...
    def __init__(self, role, goal, backstory):
        # Initialize the Crypto Agent with the given attributes
        self.role = role
        self.goal = goal
    ...
    def build_agent(self, **kwargs):
        # Build the Crypto Agent Object with the given attributes and other parameters
        agent_attributes = {
            'role': self.role,
            'goal': self.goal,
