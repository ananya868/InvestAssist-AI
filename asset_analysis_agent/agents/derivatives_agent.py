...
# Define the Derivatives Agent
class DerivativesAgent(AgentBase):
    """ 
    This class instantiates the Derivatives Agent Class
    ...
    Methods:
        ...
        returns: 
            Derivatives Agent Object
    """
    def __init__(self, role, goal, backstory):
        # Initialize the Derivatives Agent with the given attributes
        self.role = role
        self.goal = goal
    ...
    def build_agent(self, **kwargs):
        # Build the Derivatives Agent Object with the given attributes and other parameters
        agent_attributes = {
            'role': self.role,
            'goal': self.goal,
