...
# Define the Commodities Agent
class CommoditiesAgent(AgentBase):
    """ 
    This class instantiates the Commodities Agent Class
    ...
    Methods:
        ...
        returns: 
            Commodities Agent Object
    """
    def __init__(self, role, goal, backstory):
        # Initialize the Commodities Agent with the given attributes
        self.role = role
        self.goal = goal
    ...
    def build_agent(self, **kwargs):
        # Build the Commodities Agent Object with the given attributes and other parameters
        agent_attributes = {
            'role': self.role,
            'goal': self.goal,
